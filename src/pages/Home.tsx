...
export default function Home(){
    ...
    return(
        ...
        {/* <section style={{ 
            ...
            {screenWidth <= 768? <img src={fmJosh} alt="phone photographing erg" className='w-full max-h-screen '/> :<img src={desktopHero} alt="woman on erg machine" className='w-full max-h-screen '/>}
